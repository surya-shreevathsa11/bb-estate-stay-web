...
const WHATSAPP_HREF = 'https://wa.me/919535661590'
const VARA_INSTAGRAM_HREF =
  'https://www.instagram.com/vara.labs?igsh=MWx6dnBnamdzbWRtNA=='
  ...
  return (
    <footer className="site-footer">
      ...
      <p className="footer-bottom">
        © {new Date().getFullYear()} BB Estate Stay · Kodagu, Karnataka · Designed with care
      </p>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Contact BB Estate Stay on WhatsApp"
      >
